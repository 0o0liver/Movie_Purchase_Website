package edu.uci.ics.binghal.service.idm.configs;

import edu.uci.ics.binghal.service.idm.logger.ServiceLogger;
import edu.uci.ics.binghal.service.idm.models.ConfigsModel;
...
public class Configs {
    ...
    public Configs(ConfigsModel cm) throws NullPointerException {
        if (cm == null) {
            ...
            if (expiration == 0){
                ...
                System.err.println("Invalid expiration value.");
                sessionConfigValid = false;
            } else {
    ...
    public boolean isSessionConfigValid() { return sessionConfigValid; }
}
