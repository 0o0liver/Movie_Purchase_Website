...
public class transactions {
    ...
    public transactions(
            ...
            @JsonProperty(value = "amount", required = true) edu.uci.ics.binghal.service.billing.models.amount amount,
            @JsonProperty(value = "transaction_fee", required = true) edu.uci.ics.binghal.service.billing.models.transaction_fee transaction_fee,
    ...
    public edu.uci.ics.binghal.service.billing.models.amount getAmount() {
        return amount;
    }

    @JsonProperty(value = "transaction_fee")
    public edu.uci.ics.binghal.service.billing.models.transaction_fee getTransaction_fee() {
